      ...
      <div className="container">
        ...
        <div className="author flex justify-center mt-[19px] gap-[7px] items-center">
          ...
          <div className="author__content flex flex-col">
            <span>John Mac Ghlionn</span>
            <span className='font-[Poppins] text-[8px] leading-[12px]'>{t("date")}</span>
          </div>
        </div>
        <div className="more mt-[66px] max-w-[558px] mx-auto">
          <img src={'https://substackcdn.com/image/fetch/w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F36a0ab15-51fb-4bd7-93a8-9b332c56db8f_6950x4633.jpeg'} alt="Banner" />
