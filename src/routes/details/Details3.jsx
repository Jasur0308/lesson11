      ...
      <div className="container">
        ...
        <div className="author flex justify-center mt-[19px] gap-[7px] items-center">
          ...
          <div className="author__content flex flex-col">
            <img src={name} alt="Author Name" />
            <span className='font-[Poppins] text-[8px] leading-[12px]'>{t("date")}</span>
          </div>
        </div>
        <div className="more mt-[66px] max-w-[558px] mx-auto">
          <img src={'https://substackcdn.com/image/fetch/w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa7c4a2d2-c8b1-4785-bd0f-4f5e0516d9c0_4000x2627.jpeg'} alt="Banner" />
